...
// 综上，目前应用中还是采用单独的宏来提供
#ifdef __x86_64__
#define FUXI_CACHELINE_SIZE 128
#else  // !__x86_64__
#define FUXI_CACHELINE_SIZE 64
#endif  // !__x86_64__
...
// #if FUXI_GCC_VERSION > X || CLANG_VERSION > Y
// 的方式来指定，而且尤其需要注意避免使用
// #if FUXI_GCC_VERSION < X
// 的方式来试图判定『不具备』某种能力
...
#ifdef __GNUC__
#define FUXI_GCC_VERSION \
  (__GNUC__ * 10000 + __GNUC_MINOR__ * 100 + __GNUC_PATCHLEVEL__)
#endif  // __GNUC__
#ifndef GCC_VERSION
#define GCC_VERSION FUXI_GCC_VERSION
#endif  // GCC_VERSION
...
// 因此专门提供宏来满足这类场景的简化书写
#ifdef __has_include
#define FUXI_HAS_INCLUDE(header) __has_include(header)
#else  // !__has_include
#define FUXI_HAS_INCLUDE(header) false
#endif  // !__has_include
...
#if FUXI_HAS_INCLUDE("google/protobuf/patch_std_string_for_arena.h")
#include "google/protobuf/patch_std_string_for_arena.h"
#if __cplusplus >= 201703L && \
    (!defined(PROTOBUF_PATCH_STD_STRING) || PROTOBUF_PATCH_STD_STRING)
#define FUXI_USE_PROTOBUF 0
#endif
#endif
#ifndef FUXI_USE_PROTOBUF
#define FUXI_USE_PROTOBUF 1
#endif

#if FUXI_HAS_INCLUDE(<version>)
#include <version>
#endif  // FUXI_HAS_INCLUDE(<version>)

// clang-format off
// 在bazel环境启用treat_warnings_as_errors
// bazel的external_include_paths模式会对依赖库
#if FUXI_INCLUDE_EXTERNAL_AS_SYSTEM
#define FUXI_EXTERNAL(file) <file>
#else // !FUXI_HAS_INCLUDE(<absl/base/config.h>)
#define FUXI_EXTERNAL(file) #file
#endif // !FUXI_HAS_INCLUDE(<absl/base/config.h>)
// clang-format on
