...
// clang-format off
#include FUXI_EXTERNAL(absl/base/optimization.h) // ABSL_PREDICT_FALSE
// clang-format on
...
#if !__clang__ && FUXI_GCC_VERSION < 80400
ABSL_ATTRIBUTE_NOINLINE
#else  // __clang__ || FUXI_GCC_VERSION >= 80400
inline ABSL_ATTRIBUTE_ALWAYS_INLINE
#endif // __clang__ || FUXI_GCC_VERSION >= 80400
       // clang-format off
