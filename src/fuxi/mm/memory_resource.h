...
#include "fuxi/base/counter.h"      // ConcurrentAdder
#include "fuxi/base/thread_local.h" // EnumerableThreadLocal
#include "fuxi/base/environment.h"
#include "fuxi/mm/page_allocator.h" // PageAllocator
#include "fuxi/common/sanitizer_helper.h"        // SanitizerHelper
...
#define FUXI_TMP_DECLATE_MEMORY_RESOURCE class memory_resource {
FUXI_TMP_DECLATE_MEMORY_RESOURCE
#undef FUXI_TMP_DECLATE_MEMORY_RESOURCE
public:
