...
// clang-format off
#include FUXI_EXTERNAL(absl/utility/utility.h)
// clang-format on
...
class UsesAllocatorConstructor {
 ...
 private:
  ...
  FUXI_DECLARE_MEMBER_INVOCABLE(allocate, AllocatorChecker)
...
class BasicMonotonicAllocator {
 private:
  ...
  FUXI_DECLARE_MEMBER_INVOCABLE(construct, ConstructInvocable)
...
struct is_trivially_destructible<
    ::std::basic_string<CH, CT, ::next::fuxi::MonotonicAllocator<U, A>>> {
  static constexpr bool value = true;
};
#if __cplusplus < 201703L
template <typename CH, typename CT, typename U, typename A>
constexpr bool is_trivially_destructible<
    ::std::basic_string<CH, CT, ::next::fuxi::MonotonicAllocator<U, A>>>::value;
#endif // __cplusplus < 201703L

template <typename T, typename U, typename A>
struct is_trivially_destructible<
    ::std::vector<T, ::next::fuxi::MonotonicAllocator<U, A>>> {
  static constexpr bool value = ::std::is_trivially_destructible<T>::value;
};
#if __cplusplus < 201703L
template <typename T, typename U, typename A>
constexpr bool is_trivially_destructible<
    ::std::vector<T, ::next::fuxi::MonotonicAllocator<U, A>>>::value;
#endif // __cplusplus < 201703L

} // namespace std

#include "fuxi/mm/allocator.hpp"
